...
def create_spark_session():
    """
    create_spark_session function creates a spark session. SparkSession is the entry point to Spark SQL
    """
    spark = SparkSession \
        .builder \
...
def process_song_data(spark, input_data, output_data):
    """
    process_song_data function processes song_data using Spark. It reads song_data and creates songs_table and artists_table from     song_data
    """
...
def process_log_data(spark, input_data, output_data):
    """
    process_log_data function reads log_data and creates users table,time_table and songsplay table from log_data using Spark
    """
...
def main():
    """
    main function is the starting point for program execution
    """
